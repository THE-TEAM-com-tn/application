    ...
    try {
      const response = await fetch('https://app.the-team.tn/api/reclamation-submissions', {
        ...
        headers: {
          ...
          // If your Laravel API uses authentication (e.g. Sanctum), add Authorization header here
        },
      ...
      if (response.ok) {
        ...
        setFormData({ fullname: '', client_email: '',  subject: '', message: '' , type: '' }); // Reset form fields
      } else {
